...
bg = pygame.transform.scale(
    pygame.image.load("Background-GeometricBlue.png"), (1000, 1000)
)
...
reversegravityportal = pygame.transform.scale(
    pygame.image.load("GravityPortalALabelled.png"), (50, 80)
)
normalgravityportal = pygame.transform.scale(
    pygame.image.load("GravityPortalBLabelled.png"), (50, 80)
)
...
class Level:
        ...
        for object in self.objects:
            ...
            if object.obj == "reversegravityportal":
                scr.blit(
                    ...
                    (600 + 50 * object.x, 500 - 50 * object.y - 30),
                )
            if object.obj == "normalgravityportal":
                scr.blit(
                    normalgravityportal, (600 + 50 * object.x, 500 - 50 * object.y - 30)
                )
    ...
    def move(self):
        for object in self.objects:
            object.x -= 0.08
            if object.obj == "spike":
                object.hitbox = pygame.Rect(
                    600 + 50 * object.x + 20, 500 - 50 * object.y + 20, 10, 30
                )
            if object.obj == "block":
                object.hitbox = pygame.Rect(
                    600 + 50 * object.x, 500 - 50 * object.y, 50, 50
                )
            if object.obj == "jumppad":
                object.hitbox = pygame.Rect(
                    600 + 50 * object.x, 500 - 50 * object.y + 30, 50, 20
                )
            if object.obj == "reversegravityportal":
                object.hitbox = pygame.Rect(
                    600 + 50 * object.x, 500 - 50 * object.y - 30, 50, 80
                )
            if object.obj == "normalgravityportal":
                object.hitbox = pygame.Rect(
                    600 + 50 * object.x, 500 - 50 * object.y - 30, 50, 80
    ...
    def display_attempts(self):
        scr.blit(
            pygame.font.SysFont("Pusab", 32).render(
                "Attempt " + str(self.attempts), True, (255, 255, 255)
            ),
            (self.attempt_x, 200),
        )
...
def closest(lst, n):
    return lst[
        sorted([[x[0], abs(n - x[1])] for x in enumerate(lst)], key=lambda l: l[1])[0][
            0
        ]
    ]
        ...
        if len(last_visited) > 1 and path:
            for x in range(len(last_visited) - 1):
                pygame.draw.line(
                    scr,
                    (255, 255, 255),
                    (last_visited[x][0] + 25, last_visited[x][1] + 25),
                    (last_visited[x + 1][0] + 25, last_visited[x + 1][1] + 25),
                    x + 1,
                )
        ...
        for object in level.objects:
            if object.obj == "jumppad":
                ...
                if object.hitbox.colliderect(cube.hitbox):
                    ...
                    width = min(object.hitbox.right, cube.hitbox.right) - max(
                        object.hitbox.left, cube.hitbox.left
                    )
                    height = min(object.hitbox.bottom, cube.hitbox.bottom) - max(
                        object.hitbox.top, cube.hitbox.top
                    )
            ...
            if mouse[0]:
                ...
                if point_inside_rectangle(251, 225, 106, 114, mouse_x, mouse_y):
                    ...
                    easy = pygame.transform.scale(
                        pygame.image.load("Easy.png"), (50, 50)
                    )
                    normal = pygame.transform.scale(
                        pygame.image.load("Normal.png"), (50, 50)
                    )
                    hard = pygame.transform.scale(
                        pygame.image.load("Hard.png"), (50, 50)
                    )
                    main_levels = True
                    while main_levels:
                        for event in pygame.event.get():
                                ...
                                if pygame.mouse.get_pressed()[0]:
                                    ...
                                    if level_1_x == 0:
                                        if point_inside_rectangle(
                                            909, 225, 71, 150, mouse_x, mouse_y
                                        ):
                                            level_1_x -= 1000
                                    elif level_1_x == -1000:
                                        if point_inside_rectangle(
                                        ...
                                        if point_inside_rectangle(
                                            ...
                                            level_1_x += 1000
                                    if point_inside_rectangle(
                                        125, 150, 750, 300, mouse_x, mouse_y
                                    ):
                                        if level_1_x == 0:
                                            file = [
                                                x.replace("\n", "").split(",")
                                                for x in open(
                                                    "ThunderstormToucans_gdlevel.txt",
                                                    "r",
                                                ).readlines()
                                            ]
                                            ...
                                            for line in file:
                                                ...
                                                thunderstorm_toucans_objects.append(
                                                    Object(int(x), int(y), object_type)
                                                )
                                            run_level(
                                                Level(thunderstorm_toucans_objects)
                                            )
                                        elif level_1_x == -1000:
                                            file = [
                                                x.replace("\n", "").split(",")
                                                for x in open(
                                                    "BurgerchipExploration_gdlevel.txt",
                                                    "r",
                                                ).readlines()
                                            ]
                                            ...
                                            for line in file:
                                                x, y, object_type = line
                                                burgerchip_exploration_objects.append(
                                                    Object(int(x), int(y), object_type)
                                                )
                                            run_level(
                                                Level(burgerchip_exploration_objects)
                                            )
                                        elif level_1_x == -2000:
                                            file = [
                                                x.replace("\n", "").split(",")
                                                for x in open(
                                                    "StoichiometrySaviour_gdlevel.txt",
                                                    "r",
                                                ).readlines()
                                            ]
                                            ...
                                            for line in file:
                                                x, y, object_type = line
                                                stoichiometry_saviour_objects.append(
                                                    Object(int(x), int(y), object_type)
                                                )
                                            run_level(
                                                Level(stoichiometry_saviour_objects)
                                            )
                        scr.fill((0, 0, 0))
                        pygame.draw.rect(scr, (47, 71, 255), [level_1_x, 0, 1000, 600])
                        pygame.draw.rect(
                            scr, (50, 193, 1), [level_1_x + 1000, 0, 1000, 600]
                        )
                        pygame.draw.rect(
                            scr, (255, 226, 95), [level_1_x + 2000, 0, 1000, 600]
                        )
                        pygame.draw.rect(
                            scr, (23, 35, 127), [level_1_x + 125, 150, 750, 300], 0, 50
                        )
                        pygame.draw.rect(
                            scr, (25, 96, 0), [level_1_x + 1125, 150, 750, 300], 0, 50
                        )
                        pygame.draw.rect(
                            scr,
                            (127, 113, 47),
                            [level_1_x + 2125, 150, 750, 300],
                            0,
                            50,
                        )
                        ...
                        scr.blit(
                            pygame.font.SysFont("Pusab", 50).render(
                                "Thunderstorm Toucans", True, (255, 255, 255)
                            ),
                            (level_1_x + 215, 285),
                        )
                        scr.blit(
                            pygame.font.SysFont("Pusab", 50).render(
                                "Burgerchip Exploration", True, (255, 255, 255)
                            ),
                            (level_1_x + 1215, 285),
                        )
                        scr.blit(
                            pygame.font.SysFont("Pusab", 50).render(
                                "Stoichiometry Saviour", True, (255, 255, 255)
                            ),
                            (level_1_x + 2215, 285),
                        )
                        if level_1_x == 0:
                    ...
                    edit = False
                    delete = False
                    build_active = pygame.transform.scale(
                        pygame.image.load("BuildActive.png"), (83, 28)
                    )
                    build_inactive = pygame.transform.scale(
                        pygame.image.load("BuildInactive.png"), (83, 28)
                    )
                    edit_active = pygame.transform.scale(
                        pygame.image.load("EditActive.png"), (83, 28)
                    )
                    edit_inactive = pygame.transform.scale(
                        pygame.image.load("EditInactive.png"), (83, 28)
                    )
                    delete_active = pygame.transform.scale(
                        pygame.image.load("DeleteActive.png"), (83, 28)
                    )
                    delete_inactive = pygame.transform.scale(
                        pygame.image.load("DeleteInactive.png"), (83, 28)
                    )
                    save_button = pygame.transform.scale(
                        pygame.image.load("SaveButton.png"), (198, 28)
                    )
                    search_button = pygame.transform.scale(
                        pygame.image.load("SearchButton.png"), (75, 40)
                    )
                    levels_found_overlay = pygame.transform.scale(
                        pygame.image.load("LevelsFoundOverlay.png"), (1000, 600)
                    )
                    search_levels_text = pygame.transform.scale(
                        pygame.image.load("SearchLevelsText.png"), (431, 60)
                    )
                    page_index = 0
                    ...
                    while run_editor:
                        for event in pygame.event.get():
                            ...
                            if event.type == pygame.KEYDOWN:
                                ...
                                mouse_x, mouse_y = pygame.mouse.get_pos()
                                obj_x, obj_y = (
                                    mouse_x // editor_zoom + editor_x_offset,
                                    (600 - mouse_y) // editor_zoom
                                    + editor_y_offset
                                    + 1,
                                )
                                if build:
                                    if keys[pygame.K_1]:
                                        level.objects.append(
                                            Object(obj_x, obj_y, "spike")
                                        )
                                    if keys[pygame.K_2]:
                                        level.objects.append(
                                            Object(obj_x, obj_y, "block")
                                        )
                                    if keys[pygame.K_3]:
                                        level.objects.append(
                                            Object(obj_x, obj_y, "jumppad")
                                        )
                                    if keys[pygame.K_4]:
                                        level.objects.append(
                                            Object(obj_x, obj_y, "reversegravityportal")
                                        )
                                    if keys[pygame.K_5]:
                                        level.objects.append(
                                            Object(obj_x, obj_y, "normalgravityportal")
                                        )
                                    if keys[pygame.K_6]:
                                        level.objects.append(
                                            Object(obj_x, obj_y, "jumpring")
                                        )
                            if event.type == pygame.MOUSEBUTTONDOWN:
                                mouse = pygame.mouse.get_pressed()
                                if event.button == 4:
                                ...
                                if edit:
                                    if mouse[0]:
                                        ...
                                        for object in level.objects:
                                            if object.obj == "spike":
                                                if point_inside_rectangle(
                                                    (object.x - editor_x_offset)
                                                    * editor_zoom,
                                                    600
                                                    - (object.y - editor_y_offset)
                                                    * editor_zoom,
                                                    editor_zoom,
                                                    editor_zoom,
                                                    mouse_x,
                                        ...
                                        if len(objects_on_point) == 1:
                                            ...
                                            for queue in queues:
                                                if queue.elements == objects_on_point:
                                                    selected_object = queue.elements[
                                                        queue.selected_position
                                                    ]
                                                    queue.selected_position += 1
                                                    queue.selected_position %= len(
                                                        queue.elements
                                                    )
                                                    break
                                            else:
                                                queues.append(Queue(objects_on_point))
                                                selected_object = queues[-1].elements[
                                                    queues[-1].selected_position
                                                ]
                                                queues[-1].selected_position += 1
                                                queues[-1].selected_position %= len(
                                                    queues[-1].elements
                                                )
                                if point_inside_rectangle(
                                    802, 572, 198, 28, mouse_x, mouse_y
                                ):
                                    file = open(
                                    ...
                                    for object in level.objects:
                                        file.write(
                                            f"{object.x},{object.y},{object.obj}\n"
                                        )
                                    display_save_message = True
                                    file.close()
                                if point_inside_rectangle(
                                    925, 532, 75, 40, mouse_x, mouse_y
                                ):
                                    show_levels = True
                        ...
                        if not show_levels:
                            ...
                            for grid_x in range(0, 1000, 50):
                                pygame.draw.line(
                                    scr,
                                    (128, 128, 128),
                                    (grid_x + start_grid_x, 0),
                                    (grid_x + start_grid_x, 600),
                                )
                            for grid_y in range(0, 600, 50):
                                pygame.draw.line(
                                    scr,
                                    (128, 128, 128),
                                    (0, grid_y + start_grid_y),
                                    (1000, grid_y + start_grid_y),
                                )
                            ...
                            for object in level.objects:
                                if object.obj == "spike":
                                    scr.blit(
                                        pygame.transform.scale(
                                            spike, (editor_zoom, editor_zoom)
                                        ),
                                        (
                                            (object.x - editor_x_offset) * editor_zoom,
                                            600
                                            - (object.y - editor_y_offset)
                                            * editor_zoom,
                                        ),
                                ...
                                if object.obj == "jumppad":
                                    scr.blit(
                                        pygame.transform.scale(
                                            jumppad, (editor_zoom, editor_zoom // 6.25)
                                        ),
                                        (
                                            (object.x - editor_x_offset) * editor_zoom,
                                            600
                                            - (object.y - editor_y_offset) * editor_zoom
                                            + 42,
                                        ),
                                    )
                                if object.obj == "reversegravityportal":
                                    scr.blit(
                                        pygame.transform.scale(
                                            reversegravityportal,
                                            (editor_zoom, int(editor_zoom * 1.6)),
                                        ),
                                        (
                                            (object.x - editor_x_offset) * editor_zoom,
                                            600
                                ...
                                if object.obj == "jumpring":
                                    scr.blit(
                                        pygame.transform.scale(
                                            jumpring, (editor_zoom, editor_zoom)
                                        ),
                                        (
                                            (object.x - editor_x_offset) * editor_zoom,
                                            600
                            ...
                            if display_save_message:
                                scr.blit(
                                    pygame.font.SysFont("Pusab", 100).render(
                                        "Saved!", True, (255, 255, 255)
                                    ),
                                    (325, 270),
                                )
                            ...
                            scr.fill((0, 0, 0))
                            levels_found = [
                                x for x in os.listdir() if x.endswith("_gdlevel.txt")
                            ]
                            page = (
                                [
                                    levels_found[y : y + 10]
                                    for y in range(0, len(levels_found), 10)
                                ][page_index]
                                if len(levels_found) > 10
                                else [levels_found][page_index]
                            )
                            for i, level_found in enumerate(page):
                                pygame.draw.rect(
                                    ...
                                    [
                                        195,
                                        107 + i * 200 + levels_found_offset + i * 10,
                                        613,
                                        200,
                                    ],
                                )
                                scr.blit(
                                    pygame.font.SysFont("Pusab", 25).render(
                                        level_found, True, (255, 255, 255)
                                    ),
                                    (205, 117 + i * 200 + levels_found_offset + i * 10),
                                )
                            ...
                            scr.blit(
                                pygame.font.SysFont("Pusab", 20).render(
                                    f"{page_index*10+1} to {page_index*10+len(page)} of {len(levels_found)} in current directory",
                                    True,
                                    (255, 255, 255),
                                ),
                                (20, 20),
                            ...
                            if pygame.mouse.get_pressed()[0]:
                                mouse_x, mouse_y = pygame.mouse.get_pos()
                                if point_inside_rectangle(
                                    195, 107, 613, 400, mouse_x, mouse_y
                                ):
